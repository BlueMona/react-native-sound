    ...
    if (res != 0) {
      ...
      try {
        Uri uri = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" +
                this.context.getResources().getResourcePackageName(res) + '/' +
                this.context.getResources().getResourceTypeName(res) + '/' +
                this.context.getResources().getResourceEntryName(res) );
